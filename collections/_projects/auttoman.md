...
At present, Auttoman is developed within the [Patchwork](https://www.inkandswitch.com/patchwork/notebook/) system -- we are planning to release it as a standalone tool this Autumn, after further testing and refinement. We're happy to share the code with collaborators, so if you are a Kniterate user and would like to test it, please <a href="mailto:a.cameron@arts.ac.uk">get in touch</a>.